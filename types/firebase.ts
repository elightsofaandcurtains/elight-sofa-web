...
export interface UserDocument {
    ...
    permissions: string[];
    lastLogin: Timestamp | any; // Allow serverTimestamp() during creation
    createdAt: Timestamp | any; // Allow serverTimestamp() during creation
    updatedAt: Timestamp | any; // Allow serverTimestamp() during creation
    orders: number;
    totalSpent: number; // Make this required instead of optional
}
